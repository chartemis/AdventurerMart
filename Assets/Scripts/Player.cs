...
namespace Completed
{
    ...
    public class Player : MovingObject
    {
        ...
        private void Update()
        {
            ...
            if (!GameManager.instance.playersTurn || playerMoving) return;
            ...
            if (horizontal != 0 || vertical != 0)
            {
                ...
                {
                    orientation = (int)Orientation.LEFT;
                }
                else if (vertical > 0)
                {
                    orientation = (int)Orientation.UP;
                }
                else if (vertical < 0)
                {
                    orientation = (int)Orientation.DOWN;
                }
        ...
        protected override bool AttemptMove(int xDir, int yDir, out RaycastHit2D hit)
        {
